...
template <typename T>
bool write(std::ostream& out, google::protobuf::uint64 count, std::function<T(uint64_t)>& lambda) {
...
template <typename T>
bool write_single(std::ostream& out, T& value) {
